...
const russianFallback = `<!-- SEO_HOME_CONTENT_START -->
      <main>
        ...
        <section><h2>Районы и типы недвижимости</h2><ul><li><a href="/ru/areas/germasogeia-commercial-property/">Germasogeia</a></li><li><a href="/ru/areas/agios-athanasios-sea-view-apartments/">Agios Athanasios</a></li><li><a href="/ru/areas/agios-tychonas-luxury-villas/">Agios Tychonas</a></li><li><a href="/ru/areas/mesa-geitonia-new-apartments/">Mesa Geitonia</a></li></ul><p>Заявленные цены: офисное здание €8 700 000 + НДС; Athanasios от €480 000 + НДС; виллы от €1 430 000 + НДС; OLiO от €475 000 + НДС. Актуальное наличие и условия уточняются у продавца. Офисное здание готово. В галерее представлены реальные фотографии объекта. Свяжитесь с отделом продаж, чтобы договориться об индивидуальном просмотре.</p></section>
        <section aria-labelledby="guides-heading"><h2 id="guides-heading">Гиды покупателя</h2><p><a href="/ru/guides/novostroyki-limassola-sravnenie-proektov/">Сравнение четырёх проектов: квартиры, виллы и офисное здание</a>.</p></section>
      </main>
