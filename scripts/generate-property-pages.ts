...
const pages: Page[] = [
  {
    ...
    en: {
      title: 'Completed Office Building for Sale in Limassol | €8.7M',
      ...
      headline: 'A completed office building in Germasogeia, Limassol.',
      ...
      price: '€8,700,000 + VAT',
      facts: ['1,934 m² gross schedule', '18 parking spaces · 4 EV points', 'Roof garden', 'Completed building · Actual property photos'],
    ...
    ru: {
      title: 'Готовое офисное здание в Лимассоле | €8,7 млн',
      ...
      headline: 'Готовое офисное здание в Гермасойе, Лимассол.',
      ...
      price: '€8 700 000 + НДС',
      facts: ['Общая площадь 1 934 м²', '18 парковочных мест · 4 EV-точки', 'Сад на крыше', 'Здание готово · Реальные фотографии объекта'],
