...
const guides: Guide[] = [
  {
    ...
    sections: [
      ...
      { heading: 'Build a realistic ownership budget', paragraphs: ['The purchase price is only the first line. Request estimates for common-area electricity, cooling, lifts, security, cleaning, insurance and planned maintenance. Photovoltaic capacity and energy performance can help, but projected savings should be supported by technical information rather than marketing language.', 'Before committing, instruct independent legal, tax and technical advisers to review title, permits, VAT treatment, specifications and the sale structure. A buyer may ask whether a share acquisition of a property-owning company is available, as it can have different VAT implications from a direct asset purchase. It is not an automatic “no VAT” route: company liabilities, tax consequences, financing and resale must be fully reviewed before relying on any proposed structure. A direct developer conversation is useful; it is not a substitute for buyer-side due diligence.'] },
    ],
  },
  {
