...
const RU: Record<string, string> = {
  ...
  'Completed building · Actual property photos': 'Здание готово · Реальные фотографии объекта',
  'Completed': 'Здание готово',
  'Arrange a Private Viewing': 'Записаться на просмотр',
